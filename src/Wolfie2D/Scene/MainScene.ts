...
//item objects
    ...
    startScene(){
        ...
        */
        ...
        this.battleManager.setPlayers([<BattlerAI>this.mainPlayer._ai, <BattlerAI>this.mainPlayer._ai]);
        ...
        this.healthDisplays= <Label>this.add.uiElement(UIElementType.LABEL, "health", {position: new Vec2(70, 16), text: "Health: " + (<BattlerAI>this.mainPlayer._ai).health});
    ...
    updateScene(deltaT: number): void {
        ...
        let closetEnemy = this.getClosestEnemy(this.mainPlayer.position, (<PlayerController>this.mainPlayer._ai).range);
    ...
    initializePlayer(): void {
        ...
        let inventory = new InventoryManager(this, 2, "inventorySlot", new Vec2(16, 16), 2, "slots1", "items1");
        let buffBar = new InventoryManager(this, 10, "inventorySlot", new Vec2(16, 32), 2, "slots2", "items2");
    ...
    initializeEnemies(){
        ...
        let actionKnife = [new AttackAction(3, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
            ...
            new Berserk(1, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_BERSERK], [hw4_Statuses.REACHED_GOAL], {retreatDistance: 200})
        ];
        ...
        let actionsGun = [new AttackAction(3, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
            ...
            new Retreat(1, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_RETREAT], [hw4_Statuses.REACHED_GOAL, hw4_Statuses.CAN_BERSERK], {retreatDistance: 200}),
            new Berserk(1, [hw4_Statuses.LOW_HEALTH,hw4_Statuses.CAN_BERSERK], [hw4_Statuses.REACHED_GOAL], )
        ];

        //actionsGun=actionKnife;

        let actionsLongRange = [new AttackAction(2, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
            new Move(3, [], [hw4_Statuses.IN_RANGE], {inRange: 1000}),
            new Retreat(10, [hw4_Statuses.LOW_HEALTH, hw4_Statuses.CAN_RETREAT], [hw4_Statuses.REACHED_GOAL], {retreatDistance: 200}),
            new Berserk(11, [hw4_Statuses.CAN_BERSERK], [hw4_Statuses.REACHED_GOAL] )
        ];
        let actionsTanky = [new AttackAction(2, [hw4_Statuses.IN_RANGE], [hw4_Statuses.REACHED_GOAL]),
